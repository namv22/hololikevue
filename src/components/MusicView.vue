...
<div>
    <div id="posts" v-for="post in posts" v-bind:key="post.name">
        <b-card no-body style="max-width: 20rem;" img-src="https://placekitten.com/380/200" img-alt="Image" img-top class="md-elevation-12" v-if="post.tag === 'music'">
            <b-card-body>
                <md-card-media>
                    <img :src="
            ...
            <b-card-body>
                <b-button v-b-modal.modal-xl="modalId(i)" variant="outline-secondary">Xem</b-button>
